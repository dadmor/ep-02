// ========================================
// src/pages/contractor/my-offers.tsx  
// ========================================
...
export const ContractorMyOffers = () => {
  ...
  return (
    <>
      <Lead
        title="Moje Oferty"
        description="Zarządzaj swoimi ofertami na projekty termomodernizacyjne"
      />
        ...
        {allOffers.length > 0 ? (
                ...
                <CardContent className="p-6">
                  ...
                  {offer.scope && (
                    <div className="text-sm bg-gray-50 p-3 rounded mb-3">
                      <span className="font-medium">Zakres prac:</span> {offer.scope}
                    </div>
                  )}
                </CardContent>
              </Card>
          ...
          <Card>
            <CardContent className="text-center py-12">
              ...
              <Button onClick={() => navigate('/contractor/available-requests')}>
            ...
            {selectedOffer && (
              <div className="p-3 bg-gray-50 rounded">
                ...
                <div className="text-sm text-muted-foreground">
                  {selectedOffer.scope && selectedOffer.scope.slice(0, 100)}...
                </div>
              </div>
            )}
